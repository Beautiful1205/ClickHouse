  ...
  */
    ...
    public:
        ...
        static ExpressionAction applyFunction(
                const FunctionBuilderPtr &function_, const std::vector<std::string> &argument_names_,
        ...
        copyColumn(const std::string &from_name, const std::string &to_name, bool can_replace = false);
        ...
        static ExpressionAction
        arrayJoin(const NameSet &array_joined_columns, bool array_join_is_left, const Context &context);
...
/** Contains a sequence of actions on the block.
  */
    ...
    public:
        ...
        BlockInputStreamPtr
        createStreamWithNonJoinedDataIfFullOrRightJoin(const Block &source_header, UInt64 max_block_size) const;
