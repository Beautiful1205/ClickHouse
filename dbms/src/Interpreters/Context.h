...
/** A set of known objects that can be used in the query.
  ...
  */
    ...
    public:
        ...
        void setQuota(const String &name, const String &quota_key, const String &user_name,
        ...
        void assertTableDoesntExist(const String &database_name, const String &table_name,
                                    bool check_database_acccess_rights = true) const;
        ...
        String
        getDefaultFormat() const;    /// If default_format is not specified, some global default format is returned.
        ...
        /// I/O formats.
        BlockInputStreamPtr
        getInputFormat(const String &name, ReadBuffer &buf, const Block &sample, UInt64 max_block_size) const;
        ...
        acquireSession(const String &session_id, std::chrono::steady_clock::duration timeout, bool session_check) const;
        ...
        void
        checkPartitionCanBeDropped(const String &database, const String &table, const size_t &partition_size) const;
    ...
    private:
        ...
        void checkCanBeDropped(const String &database, const String &table, const size_t &size,
                               const size_t &max_size_to_drop) const;
    };
