...
/// Query and information about its execution.
    ...
    public:
        ...
        QueryStatusInfo
        getInfo(bool get_thread_list = false, bool get_profile_events = false, bool get_settings = false) const;
...
/// Keeps iterator to process list and removes element in destructor.
    ...
    public:
        ...
        CancellationCode
        sendCancelToQuery(const String &current_query_id, const String &current_user, bool kill = false);
