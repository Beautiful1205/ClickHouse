...
/** During insertion, buffers the data in the RAM until certain thresholds are exceeded.
  ...
  */
    ...
    public:
        ...
        bool optimize(const ASTPtr &query, const ASTPtr &partition, bool final, bool deduplicate,
    ...
    private:
        ...
        bool checkThresholds(const Buffer &buffer, time_t current_time, size_t additional_rows = 0,
                             size_t additional_bytes = 0) const;
