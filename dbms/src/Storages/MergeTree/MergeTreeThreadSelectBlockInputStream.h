...
/** Used in conjunction with MergeTreeReadPool, asking it for more work to do and performing whatever reads it is asked to perform.
  * 与MergeTreeReadPool结合使用, 要求它做更多的工作, 并执行要求它执行的任何读取操作
  */
//NOTE: MergeTreeThreadSelectBlockInputStream是继承了MergeTreeBaseSelectBlockInputStream中的readImpl()方法
